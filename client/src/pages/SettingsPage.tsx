    ...
    <React.Fragment>
      ...
      >
        ...
        <DropButton
          ...
          fill="horizontal"
        />
        <Box align="end" justify="end" fill="horizontal" direction="row">
          <Tabs justify="end">
        ...
        >
          ...
          <Accordion multiple={false}>
            ...
            <AccordionPanel label="Delete This Tree">
              <Text>
                Collaborators will be notified that this tree will be deleted
                and will have the option to save a copy within 7 days. Please
                type in the tree's name and press the button below to confirm.
              </Text>
              <TextInput />
